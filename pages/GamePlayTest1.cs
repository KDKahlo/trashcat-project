...
{
    //this will allow for parellel test execution
    [TestFixture]
    ...
    public class GamePlayTest1
    {
        ...
        public void SetUp()
        {
            Driver = new AltDriver(port: 13000, platform: "Android");
        ...
        public void ActivateCheat()
        {
            ...
            Console.WriteLine("Player Current Speed: " + gamePlayPage.GetPlayerCurrentSpeed(gamePlayPage.PlayerPivot));
            Console.WriteLine("Player Current Lane: " + gamePlayPage.GetPlayerCurrentLane(gamePlayPage.PlayerPivot));
        }
